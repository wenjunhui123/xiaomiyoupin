...
//MKDIR && RMDIR && READ-DIR && READ-FILE && READ-FILE &&COPY-FILE 
['mkdir', 'rmdir', 'readdir', 'readFile', 'copyFile', 'unlink'].forEach(item => {
    exports[item] = function (pathname, copypath = '') {
        ...
        return new Promise((resolve, reject) => {
            ...
            if (item === 'readFile') {
                !/(JPG|JPEG|PNG|GIF|SVG|ICO|BMP|EOT|TTF|WOFF|MP3|MP4|OGG|WAV|M4A|WMV|AVI)$/i.test(pathname) ?
                    arg.unshift('utf8') : null;
            }
